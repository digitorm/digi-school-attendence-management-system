<?php
	...
	$Translation['AppDigi forum'] = "AppDigi Community Forum";
	...
	$Translation['data ownership'] = "Sometimes, you might have tables with data that were entered before implementing this AppDigi membership management system, or entered using other applications unaware of AppDigi ownership system. This data currently has no owners. This page allows you to assign owner groups and owner members to this data.";
	...
	$Translation['compare tables page'] = "This page compares the tables and fields structure/schema as designed in AppDigi to the actual database structure and allows you to fix any deviations.";
	$Translation['field'] = "Field";
	$Translation['AppDigi definition'] = "AppDigi definition";
	...
	$Translation['fix field'] = "Fix the field by running an ALTER COLUMN query so that its definition becomes the same as that in AppDigi.";
	$Translation['fix it'] = "Fix it";
	$Translation['field update warning'] = "DANGER!! In some cases, this might lead to data loss, truncation, or corruption. It might be a better idea sometimes to update the field in AppDigi to match that in the database. Would you still like to continue?";
