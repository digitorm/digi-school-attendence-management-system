<?php
	...
	// PLEASE NOTE:
	// ============
	// When a new version of AppDigi is released, new strings
	...
	$Translation['db_name help'] = 'The name of the database you want to run your AppDigi application in.';
