...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	<head>
		...
		<script>var $j = jQuery.noConflict(); var AppDigi = AppDigi || {};</script>
				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li class="divider"></li>
							<li><a href="https://forums.appdigi.com" target="_blank"><i class="glyphicon menu-item-icon text-info glyphicon-new-window"></i> <?php echo $Translation['AppDigi forum']; ?></a></li>
						</ul>
					</li>
