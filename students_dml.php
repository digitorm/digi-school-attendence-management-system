...
function students_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = ''){
	...
	<script>
		...
		AppDigi.current_course__RAND__ = { text: "", value: "<?php echo addslashes($selected_id ? $urow['course'] : $filterer_course); ?>"};
			...
			$j("#course-container__RAND__").select2({
				...
				initSelection: function(e, c){
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { id: AppDigi.current_course__RAND__.value, t: 'students', f: 'course' },
				...
				AppDigi.current_course__RAND__.value = e.added.id;
				AppDigi.current_course__RAND__.text = e.added.text;
